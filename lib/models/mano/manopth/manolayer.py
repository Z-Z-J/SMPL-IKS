...
from lib.models.mano.mano.webuser.smpl_handpca_wrapper_HAND_only import ready_arguments
from lib.models.mano.manopth import rodrigues_layer, rotproj, rot6d
from lib.models.mano.manopth.tensutils import (th_posemap_axisang, th_with_zeros, th_pack,
...
class MANOLayer(Module):
    ...
    def forward(self,
        ...
        """
        output = ModelOutput(
            vertices=th_verts, joints=th_jtr)
        return output
