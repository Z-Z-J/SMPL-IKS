...
from lib.ap.smplx.AP import SMPLX_AP_V1, SMPLX_AP_V2
    ...
    def validate(self):
        ...
        for i, target in enumerate(self.valid_loader):
            ...
            with torch.no_grad():
                ...
                #-------------------SMPLX-SI-----------------------------------
                pred_betas, pred_leg_twist_phi, pred_spine_twist_phi, pred_arm_hand_twist_phi = self.generator(p_pos)
                ...
                smplx_out = self.smplx(
                    betas = pred_betas,
                    global_orient = gt_global_orient_rotmat_0, body_pose = body_pose_rotmat_0,
