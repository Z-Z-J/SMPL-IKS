...
class SMPLIKSLoss(nn.Module):
    def __init__(
        ...
        super(SMPLIKSLoss, self).__init__()
    ...
    def forward(
        ...
        loss_arm_theta = self.criterion_smpl(hybrik_arm_pose, gt_arm_pose) 
        loss_spine_theta = self.criterion_smpl(hybrik_spine_pose, gt_spine_pose)
        loss_leg_theta = self.criterion_smpl(hybrik_leg_pose, gt_leg_pose)
        ...
        loss_theta = (loss_arm_theta + loss_spine_theta + loss_leg_theta) * self.e_theta_loss_weight
